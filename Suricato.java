    ...
    public void run() {
        while(true){
            try {
                ...
                System.out.println("\u001B[33m" + this.especie + " " + this.id + " quer comer " + comidaConsumidaNessaRefeicao + " unidades de comida." + "\u001B[0m");
                comedouro.comer(this, comidaConsumidaNessaRefeicao);
                Thread.yield();

                // O animal para de comer e se exibe
                System.out.println("\u001B[33m" + this.especie + " " + this.id + " terminou de comer " + comidaConsumidaNessaRefeicao + " unidades de comida." + "\u001B[0m");
                this.comidaConsumida += comidaConsumidaNessaRefeicao;
                System.out.println("\u001B[33m" + this.especie + " " + this.id + " começou a se exibir." + "\u001B[0m");
                ...
                System.out.println("\u001B[33m" + this.especie + " " + this.id + " vai dormir por " + tempoDeSono + " horas (segundos)." + "\u001B[0m");
